// from: https://github.com/validatorjs/validator.js/blob/master/src/lib/isISO31661Alpha3.js
const countryIso3Codes: string[] = [
  ...
  'CYN', 'KOS', 'SOL', // non-official
];

export default countryIso3Codes;
